            ...
            <tbody>
                ...
                <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    <th scope="row" class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                        <img src="{{ asset('img/'. $item->images) }}" class="rounded-xl h-[70px] object-cover" width="100" height="100" alt="">
                    </th>
                    <td class="px-6 py-4">
                       {{$item->name}}
                    </td>
                    ...
                    <td class="px-6 py-4">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form class="inline" action="{{route('todo.destroy',$item->id)}}" method="POST">
                                            ...
                                            @method('DELETE')
                                            <button type="submit"
                                                class="rounded-lg bg-green-700 text-white py-2.5 px-5">انجام
                                                دادم</button>
                                        </form>
                        ...
                        <a href="{{route('todo.edit',$item->id)}}"
                            class="rounded-lg bg-blue-400 text-white py-1 px-3">Edit</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
